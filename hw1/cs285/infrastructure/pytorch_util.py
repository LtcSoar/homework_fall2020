...
def build_mlp(
    ...
    model.add_module("hidden_layer_1",nn.Linear(input_size,size))
    model.add_module("activation_1",activation)
    for i in range(2,n_layers+1):
        model.add_module(f"hidden_layer_{i}",nn.Linear(size,size))
